...
FILE="$ROOT/interfaces/web_admin/routes/monitoring.py"
BACKUP="$ROOT/backups/monitoring_py_$(date +%Y%m%d_%H%M%S)_safe_fix.py"
...
echo "Backup: $BACKUP"
echo "monitoring.py replaced with safe version"
